    ...
    for directory in directories:
        for filename in os.listdir(directory):
            if filename.startswith("EXP") and filename.endswith(".csv"):
                ...
                df = trim_to_peaks(df)#, sampling_freq)  # Remove the first 'lines_to_trim' lines
...
joblib.dump(normalized_folds, 'normalized_folds_pca_allData_peakTrim.pkl')
joblib.dump(scalers, 'scalers_pca_allData_peakTrim.pkl')
joblib.dump(encoded_labels, 'encoded_labels_pca_allData_peakTrim.pkl')
joblib.dump(encoder, 'encoder_pca_allData_peakTrim.pkl')
joblib.dump(pcas, 'pcas_pca_allData_peakTrim.pkl')
